...
class InferenceEngine:
    ...
    def makeInference(self, trajJSON, inferences, eps=2/6471, min_samples=7):
        trajectory = Trajectory.fromGeoJSON(trajJSON)
        inferences = self.infer(trajectory, inferences, eps, min_samples)
    ...
    #TODO
    # PRETTY SURE epsilon in this case is 2 meters. 
    def infer(self, trajectory, inferences, eps=2/6371, min_samples=7):
        # cluster Data
        indexClusters = self.cluster(trajectory, eps, min_samples)
